...
def contenttype_folder(content_type, desc=None, fromCheck=False, custom_folder=None):
    ...
    if content_type == "Checkpoint":
        ...
        # Fix: use custom_folder if not None, else main_data
        folder = os.path.join(custom_folder if custom_folder else main_data, "aesthetic_embeddings")
    elif content_type == "LORA":
        # Always use default folder path
